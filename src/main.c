...
#ifdef _WIN32
void kr_sleep_ms(int64_t ms) { Sleep((DWORD)ms); }
int64_t kr_setenv(kr_str name, kr_str val, ...) { return (int64_t)_putenv_s(name, val); }
void kr_unsetenv(kr_str name) { _putenv_s(name, ""); }
#undef kr_snprintf
#define kr_snprintf _snprintf
#define kr_strdup _strdup
#ifndef strdup
#define strdup _strdup
#endif
#endif
...
Target kr_detect_host_target() {
    __auto_type os = kr_detect_host_os();
    __auto_type arch = kr_detect_host_arch();
    if (_KR_EQ(os, kr_OS_WINDOWS())) {
        if (_KR_EQ(arch, kr_ARCH_AARCH64())) {
            return kr_parse_target("aarch64-pc-windows-msvc");
        }
        return kr_parse_target("x86_64-pc-windows-msvc");
    }
    if (_KR_EQ(os, kr_OS_MACOS())) {
        if (_KR_EQ(arch, kr_ARCH_AARCH64())) {
            return kr_parse_target("aarch64-apple-darwin");
        }
        return kr_parse_target("x86_64-apple-darwin");
    }
    if (_KR_EQ(os, kr_OS_FREEBSD())) {
    ...
    if (_KR_EQ(arch, kr_ARCH_AARCH64())) {
        return kr_parse_target("aarch64-unknown-linux-gnu");
    }
    return kr_parse_target("x86_64-unknown-linux-gnu");
}
...
kr_str kr_cc_extra_flags(Target t) {
    if (_KR_EQ(t.os, kr_OS_WINDOWS())) {
        return "-D_CRT_SECURE_NO_WARNINGS";
    }
    return "";
}
...
kr_str kr_c_includes_windows() {
    return kr_str_concat(kr_str_concat(kr_str_concat(kr_str_concat(kr_str_concat(kr_str_concat(kr_str_concat(kr_str_concat(kr_str_concat(kr_str_concat("#include <stdio.h>\n", "#include <stdlib.h>\n"), "#include <string.h>\n"), "#include <stdint.h>\n"), "#include <stdbool.h>\n"), "#include <math.h>\n"), "#include <time.h>\n"), "#include <ctype.h>\n"), "#include <stdarg.h>\n"), "#define WIN32_LEAN_AND_MEAN\n"), "#include <windows.h>\n");
}
...
kr_str kr_c_includes_portable() {
    return kr_str_concat(kr_str_concat(kr_str_concat(kr_str_concat(kr_str_concat(kr_str_concat(kr_str_concat(kr_str_concat("#include <stdio.h>\n", "#include <stdlib.h>\n"), "#include <string.h>\n"), "#include <stdint.h>\n"), "#include <stdbool.h>\n"), "#include <math.h>\n"), kr_str_concat(kr_str_concat("#include <time.h>\n", "#include <ctype.h>\n"), "#include <stdarg.h>\n")), "#ifdef _WIN32\n"), kr_str_concat(kr_str_concat("#define WIN32_LEAN_AND_MEAN\n", "#include <windows.h>\n"), kr_str_concat("#else\n", kr_str_concat("#include <unistd.h>\n", "#endif\n"))));
}
...
kr_str kr_c_runtime_shims_posix() {
    ...
    s = kr_str_concat(s, "#ifndef _WIN32\nvoid kr_sleep_ms(int64_t ms) { usleep((unsigned)(ms*1000)); }\n#endif\n");
    ...
    s = kr_str_concat(s, "#ifdef _WIN32\n#ifndef strdup\n#define strdup _strdup\n#endif\n#endif\n");
...
kr_str kr_c_runtime_shims_windows() {
    ...
    s = kr_str_concat(s, "#ifdef _WIN32\n");
    s = kr_str_concat(s, "void kr_sleep_ms(int64_t ms) { Sleep((DWORD)ms); }\n");
    s = kr_str_concat(s, "int64_t kr_setenv(kr_str name, kr_str val, ...) { return (int64_t)_putenv_s(name, val); }\n");
    s = kr_str_concat(s, "void kr_unsetenv(kr_str name) { _putenv_s(name, \"\"); }\n");
    s = kr_str_concat(s, "#undef kr_snprintf\n");
    s = kr_str_concat(s, "#define kr_snprintf _snprintf\n");
    s = kr_str_concat(s, "#define kr_strdup _strdup\n");
    s = kr_str_concat(s, "#ifndef strdup\n#define strdup _strdup\n#endif\n");
    s = kr_str_concat(s, "#endif\n");
    return s;
}
