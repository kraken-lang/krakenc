...
int64_t kr_distance_sq(Point p) {
    return _KR_ADD(p.x * p.x, p.y * p.y);
}
...
int64_t kr_main() {
    ...
    kr_puts(kr_str_concat("dist_sq: ", kr_fmt_int((int64_t)(intptr_t)(kr_distance_sq(p)))));
    kr_puts(kr_str_concat("sum(10): ", kr_fmt_int((int64_t)(intptr_t)(kr_count_to(10)))));
    kr_puts(kr_check_keyword("fn"));
    kr_puts(kr_check_keyword("let"));
    kr_puts(kr_check_keyword("hello"));
    for (int64_t i = 0; i < 3; i = _KR_ADD(i, 1)) {
        kr_puts(kr_str_concat("i=", kr_fmt_int((int64_t)(intptr_t)(i))));
    }
    return 0;
}
