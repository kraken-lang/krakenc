...
int64_t kr_square(int64_t x);
int64_t kr_cube(int64_t x);
int64_t kr_main();
...
int64_t kr_main() {
    kr_puts(kr_str_concat("square(5)=", kr_fmt_int(kr_square(5))));
    kr_puts(kr_str_concat("cube(3)=", kr_fmt_int(kr_cube(3))));
    return 0;
}
